...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static TextMesh CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder) {
            ...
            Transform transform = gameObject.transform;
            transform.localScale = Vector3.one * 0.02f; // SIZE FACTOR
            transform.SetParent(parent, false);
            transform.localPosition = localPosition;
        ...
        public static void CreateWorldTextPopup(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, Vector3 finalPopupPosition, float popupTime) {
            ...
            FunctionUpdater.Create(delegate () {
                transform.position += moveAmount * Time.unscaledDeltaTime / 10f; // MOVEMENT FACTOR
                textMesh.color = new(textMesh.color.r, textMesh.color.g, textMesh.color.b, textMesh.color.a - 1 / popupTime * Time.unscaledDeltaTime);
